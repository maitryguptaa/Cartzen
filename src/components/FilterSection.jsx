...
const FilterSection = ({search, setSearch, brand,  priceRange,  category, setPriceRange,setBrand, handleBrandChange, handleCategoryChange, setCategory}) => {
    ...
    return (
        <div className='bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block'>
            ...
            <h1 className='mt-5 font-semibold text-xl mb-3'>Brand</h1>
             ...
             <button className='bg-pink-500 text-white rounded-md px-3 py-1 mt-5 cursor-pointer'
